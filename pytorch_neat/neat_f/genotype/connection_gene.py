...
class ConnectionGene:
    ...
    def _get_correct_innovation_num(self):
        ...
        for connect_gene in neat_f.population.Population.current_gen_innovation:
            if self == connect_gene:
                return connect_gene.innov_num
        # Is new innovation
        neat_f.population.Population.current_gen_innovation.append(self)
        return neat_f.population.Population.get_new_innovation_num()
